...
exports.BUILT_IN_NETWORKS = {
    ...
    [types_1.NetworkType['adil-testnet']]: {
        chainId: types_1.ChainId['adil-testnet'],
        ticker: types_1.NetworksTicker['adil-testnet'],
        rpcPrefs: {
            blockExplorerUrl: 'https://testnet.adilchain-scan.io/',
        },
    },
    [types_1.NetworkType['adil-mainnet']]: {
        chainId: types_1.ChainId['adil-mainnet'],
        ticker: types_1.NetworksTicker['adil-mainnet'],
        rpcPrefs: {
...
exports.NETWORK_ID_TO_ETHERS_NETWORK_NAME_MAP = {
    ...
    [types_1.NetworkId['adil-testnet']]: types_1.NetworkType['adil-testnet'],
    [types_1.NetworkId['adil-mainnet']]: types_1.NetworkType['adil-mainnet'],
};
