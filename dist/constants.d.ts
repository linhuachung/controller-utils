...
export declare const BUILT_IN_NETWORKS: {
    ...
    readonly "adil-testnet": {
        readonly chainId: "0x1d97";
        readonly ticker: typeof NetworksTicker["adil-testnet"];
        readonly rpcPrefs: {
            readonly blockExplorerUrl: "https://testnet.adilchain-scan.io/";
        };
    };
    readonly "adil-mainnet": {
        readonly chainId: "0x1d98";
        readonly ticker: typeof NetworksTicker["adil-testnet"];
        readonly rpcPrefs: {
            readonly blockExplorerUrl: "https://adilchain-scan.io/";
        };
    };
    readonly rpc: {
